...
public class POJOJsonPlaceHolder {
    ...
    //1.adim : objemiz içerisinde varolan tum key degerlerini private Variable olarak tanimlayalim:
    ...
    //3.adim : tum parametreleri içeren bir constructor create edelim:
    ...
    //4.adim parametresiz constructor olusturalim
